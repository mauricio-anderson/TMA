...
\begin{figure*}[!t]
\centering
\subfigure[]{\includegraphics[width=18cm]{LSR}%
\label{fig_k_core_LSR}}
\hfil
\subfigure[]{\includegraphics[width=18cm]{MPLS}%
...
\begin{figure*}[!htb]
\centering
\subfigure[AS1299  Teliasonera AB , $C_{\max}=21$, $\text{Degree}_{\max}=2781$]{\includegraphics[width=2in]{1299}%
\label{fig_cluster_mpls_1299}}
\hfill
\subfigure[AS174 Congent Communication, $C_{\max}=8$, $\text{Degree}_{\max}=751$]{\includegraphics[width=2in]{174}%
\label{fig_cluster_mpls_174}}
\hfill
\subfigure[AS6762 Telecom Italia, $C_{\max}=10$, $\text{Degree}_{\max}=564$]{\includegraphics[width=2in]{6762}%
\label{fig_cluster_mpls_6762}}
\hfill
\subfigure[AS7018 AT\&T, $C_{\max}=3$, $\text{Degree}_{\max}=745$]{\includegraphics[width=2in]{2914}%
\label{fig_cluster_mpls_2914}}
\hfil
\subfigure[ AS1273 Cable and Wireless Worldwide plc, $C_{\max}=3$, $\text{Degree}_{\max}=806$]{\includegraphics[width=2in]{1273}%
\label{fig_cluster_mpls_1273}}
\hfil
\subfigure[AS2914 Citicorp, $C_{\max}=4$, $\text{Degree}_{\max}=745$]{\includegraphics[width=2in]{7018}%
