...
balancing, \ldots) varies in time and according to ASes.

However, the MPLS deployment impact on the Internet architecture has not been
...
provide some porperties and architectural details related with MPLS deployment
